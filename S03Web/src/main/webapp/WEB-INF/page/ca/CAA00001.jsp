...
function initPage(){
    ...
    drawEquipment = function(equipmentList) {
        ...
        equipmentList.forEach(function(equip) {
            ...
            debugger;
            console.log('chk=='+equip.imgPath);
            equipImage.src = '${pageContext.request.contextPath}/api/cmn/file/GetImgVw.do?filePath='+equip.imgPath;
    ...
    function doAction(sAction)
    {
    	...
    	case "SaveIOT" :
    		...
    		var url = "${pageContext.request.contextPath}/api/ca/caa/saveZ01IOTList.do";
